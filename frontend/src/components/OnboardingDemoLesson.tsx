...
export const OnboardingDemoLesson = ({
  ...
  const [code, setCode] = useState(
    '# Welcome! Type your first Python code here\nprint("Hello, World!")',
  );
  ...
  const handleRunCode = async () => {
    ...
    try {
      ...
      setOutput(
        (response as any).output || (response as any).result || "Code executed",
      );
    } catch (error: any) {
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            This is your code editor. Try running the code, then modify it and
            run again!
          </p>
          {recommendation && (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                1. Click the <strong>"Run Code"</strong> button to execute your
                code
              </p>
              <p>2. Try changing the message inside the quotes</p>
              <p>3. Run it again to see your changes</p>
              <p>
