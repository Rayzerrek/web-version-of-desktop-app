...
export default function QuizLesson({
    ...
    const handleSelectOption = (index: number) => {
        ...
        if (correct) {
            ...
            if (userId && lessonId) {
                progressService.markLessonCompleted(userId, lessonId).catch((error) =>
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    >
                        ...
                        <div className="mb-8">
                            ...
                            <div className="space-y-3">
                                {quizContent.options.map((option, index) => {
                                    ...
                                    let bgColor = 'bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700'
                                    ...
                                    return (
                                        <button
                                            ...
                                            disabled={isAnswered}
                                            className={`w-full text-left p-4 rounded-xl border transition-all ${borderColor} ${bgColor} ${textColor} ${isAnswered ? 'cursor-default' : 'cursor-pointer'
                                                }`}
                                        >
                        ...
                        {showFeedback && quizContent.explanation && (
                            <div
                                className={`mt-8 p-6 rounded-2xl border-l-4 ${isCorrect
