...
import type { OnboardingAnswers, OnboardingRecommendation } from "../types/onboarding";
import { interestOptions, experienceOptions, getInterstitialMessage, getFinalMessage } from "../utils/startQuizQuestions";
import { apiFetch, authHeaders } from "../services/ApiClient";

interface OnBoardingQuizProps {
    onComplete: (recommendation: OnboardingRecommendation, answers: OnboardingAnswers) => void;
    onSkip: () => void;
}
...
export const OnBoardingQuiz = ({ onComplete, onSkip }: OnBoardingQuizProps) => {
    ...
    const handleInterestSelect = (interest: string) => {
        setAnswers({ ...answers, interest: interest as OnboardingAnswers['interest'] });
    };

    const handleExperienceSelect = (experience: string) => {
        setAnswers({ ...answers, experience: experience as OnboardingAnswers['experience'] });
    };
    ...
    const handleComplete = async () => {
        ...
        try {
            ...
            const response = await apiFetch<OnboardingRecommendation>('/users/onboarding', {
                method: 'POST',
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-300">
                                Let's find a learning path for you. What are you most interested in?
                            </p>
                        </div>
